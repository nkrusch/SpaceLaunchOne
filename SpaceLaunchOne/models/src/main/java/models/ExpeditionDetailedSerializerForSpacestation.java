...
public class ExpeditionDetailedSerializerForSpacestation {
  ...
  **/
  ...
  public ExpeditionDetailedSerializerForSpacestation name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ExpeditionDetailedSerializerForSpacestation start(OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public ExpeditionDetailedSerializerForSpacestation end(OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, name, start, end, crew);
  }
