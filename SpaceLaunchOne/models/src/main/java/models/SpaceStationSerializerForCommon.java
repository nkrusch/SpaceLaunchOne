...
public class SpaceStationSerializerForCommon {
  ...
  **/
  ...
  public SpaceStationSerializerForCommon name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SpaceStationSerializerForCommon status(SpaceStationStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public SpaceStationSerializerForCommon founded(LocalDate founded) {
  ...
  **/
  ...
  public SpaceStationSerializerForCommon description(String description) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, name, status, founded, description, orbit, imageUrl);
  }
