...
public class LauncherDetail {
  ...
  **/
  ...
  public LauncherDetail flightProven(Boolean flightProven) {
  ...
  **/
  ...
  public LauncherDetail serialNumber(String serialNumber) {
  ...
  **/
  ...
  public LauncherDetail status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public LauncherDetail details(String details) {
  ...
  **/
  ...
  public LauncherDetail launcherConfig(LauncherConfigDetail launcherConfig) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, flightProven, serialNumber, status, details, launcherConfig, imageUrl, successfulLandings, attemptedLandings, flights, lastLaunchDate, firstLaunchDate);
  }
