...
public class LauncherConfigDetail {
  ...
  private String launchCost = null;
  ...
  **/
  ...
  public LauncherConfigDetail name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public LauncherConfigDetail description(String description) {
  ...
  **/
  ...
  public LauncherConfigDetail family(String family) {
    this.family = family;
    return this;
  }
  ...
  **/
  ...
  public LauncherConfigDetail fullName(String fullName) {
  ...
  **/
  ...
  public LauncherConfigDetail manufacturer(AgencySerializerDetailedCommon manufacturer) {
  ...
  **/
  ...
  public LauncherConfigDetail variant(String variant) {
  ...
  **/
  ...
  public LauncherConfigDetail alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  **/
  ...
  public LauncherConfigDetail minStage(Integer minStage) {
  ...
  **/
  ...
  public LauncherConfigDetail maxStage(Integer maxStage) {
  ...
  **/
  ...
  public LauncherConfigDetail length(BigDecimal length) {
    this.length = length;
    return this;
  }
  ...
  **/
  ...
  public LauncherConfigDetail diameter(BigDecimal diameter) {
  ...
  **/
  ...
  public LauncherConfigDetail maidenFlight(LocalDate maidenFlight) {
  ...
  **/
  ...
  public LauncherConfigDetail launchCost(String launchCost) {
  ...
  **/
  ...
  public LauncherConfigDetail launchMass(Integer launchMass) {
  ...
  **/
  ...
  public LauncherConfigDetail leoCapacity(Integer leoCapacity) {
  ...
  **/
  ...
  public LauncherConfigDetail gtoCapacity(Integer gtoCapacity) {
  ...
  **/
  ...
  public LauncherConfigDetail toThrust(Integer toThrust) {
  ...
  **/
  ...
  public LauncherConfigDetail apogee(Integer apogee) {
    this.apogee = apogee;
    return this;
  }
  ...
  **/
  ...
  public LauncherConfigDetail vehicleRange(Integer vehicleRange) {
  ...
  **/
  ...
  public LauncherConfigDetail infoUrl(String infoUrl) {
  ...
  **/
  ...
  public LauncherConfigDetail wikiUrl(String wikiUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, launcherConfigDetail.id) &&
        ...
        Objects.equals(this.launchCost, launcherConfigDetail.launchCost) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, name, description, family, fullName, manufacturer, program, variant, alias, minStage, maxStage, length, diameter, maidenFlight, launchCost, launchMass, leoCapacity, gtoCapacity, toThrust, apogee, vehicleRange, imageUrl, infoUrl, wikiUrl, totalLaunchCount, consecutiveSuccessfulLaunches, successfulLaunches, failedLaunches, pendingLaunches);
  }
  ...
  public String toString() {
    ...
    sb.append("    launchCost: ").append(toIndentedString(launchCost)).append("\n");
