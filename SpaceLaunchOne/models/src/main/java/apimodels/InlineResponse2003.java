...
public class InlineResponse2003 {
  ...
  private List<SpacecraftConfiguration> results = null;
   ...
   **/
  @ApiModelProperty(required = true)
  public List<SpacecraftConfiguration> getResults() {
    return results;
  }
  public void setResults(List<SpacecraftConfiguration> results) {
