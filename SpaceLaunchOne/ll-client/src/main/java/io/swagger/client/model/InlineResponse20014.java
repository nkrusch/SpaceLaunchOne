...
import io.swagger.client.model.SpaceStation;
import java.util.*;
...
public class InlineResponse20014 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.count == null ? inlineResponse20014.count == null : this.count.equals(inlineResponse20014.count)) &&
        (this.next == null ? inlineResponse20014.next == null : this.next.equals(inlineResponse20014.next)) &&
        (this.previous == null ? inlineResponse20014.previous == null : this.previous.equals(inlineResponse20014.previous)) &&
        (this.results == null ? inlineResponse20014.results == null : this.results.equals(inlineResponse20014.results));
  }
